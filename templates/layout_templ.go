...
func Layout(title string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 2, "</title><script src=\"https://cdn.tailwindcss.com\"></script><link rel=\"stylesheet\" href=\"https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css\"></head><body class=\"bg-gray-50 flex flex-col min-h-screen\"><header class=\"bg-white shadow-md\"><div class=\"container mx-auto px-4\"><div class=\"flex justify-between items-center py-4\"><div class=\"flex items-center\"><a href=\"/\" class=\"text-blue-600 font-bold text-xl\">RPCplorer</a></div><div class=\"hidden md:flex flex-1 justify-center px-4\"><div class=\"relative w-full max-w-xl\"><input type=\"text\" placeholder=\"Search by Address / Txn Hash / Block / Token\" class=\"w-full py-2 px-4 pr-10 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500\"> <button class=\"absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400\"><i class=\"fas fa-search\"></i></button></div></div><nav class=\"hidden md:flex space-x-6\"><a href=\"#\" class=\"text-gray-600 hover:text-blue-600\">Home</a> <a href=\"#\" class=\"text-gray-600 hover:text-blue-600\">Blockchain</a> <a href=\"#\" class=\"text-gray-600 hover:text-blue-600\">Tokens</a> <a href=\"#\" class=\"text-gray-600 hover:text-blue-600\">Resources</a> <a href=\"#\" class=\"text-gray-600 hover:text-blue-600\">More</a></nav><button class=\"md:hidden\"><i class=\"fas fa-bars text-gray-600\"></i></button></div></div></header><main class=\"flex-grow\">")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
